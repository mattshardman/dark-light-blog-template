...
function Header(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("header", {
    ...
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["1517035907", [dark ? '#30353d' : '#f9fbff', isScrolled ? '80px' : '120px', color, dark ? '0%' : '100%', isScrolled ? '35px' : '40px']]]) + " " + "logo-section",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
...
//# sourceMappingURL=index.js.80ba3cf16fcba137c99c.hot-update.js.map