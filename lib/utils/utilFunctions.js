...
export const bodyParser = (element) => {
  if (element.type === 'heading1') {
    return <h1 key={element.id}>{element.text}</h1>;
  }

  if (element.type === 'heading2') {
    return <h2 key={element.id}>{element.text}</h2>;
  }
  ...
  if (element.type === 'heading4') {
    return <h4 key={element.id}>{element.text}</h4>;
  }

  if (element.type === 'heading5') {
    return <h5 key={element.id}>{element.text}</h5>;
  }

  if (element.type === 'heading6') {
    return <h6 key={element.id}>{element.text}</h6>;
  }
  ...
  if (element.type === 'list-item') {
    return <ul key={element.id}><li>{element.text}</li></ul>;
  }
